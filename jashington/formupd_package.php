...
<center>
<div class="form">
    <div class="form-heading">UPDATE PACKAGE DETAILS<br></div>
    <form action="phpupd_package.php?id=<?php echo $id;?>" method="post">
    
    <fieldset disabled>
    <label for="packagecode"><span>PACKAGE CODE<span class="required"> *</span></span>
      <input name="packagecode" type="text" required class="input-field" id="packagecode" value='<?=$row['packagecode'];?>' maxlength="10" /></label>
    </fieldset>
        
        <p>
          <label for="packagename"><span>PACKAGE NAME<span class="required"> *</span></span>
            <input type="text" required class="input-field" name="packagename" value='<?=$row['packagename'];?>' id="packagename" maxlength="100" />
            <br>
            <br>
          </label>
