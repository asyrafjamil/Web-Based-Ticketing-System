...
<center>
<div class="form">
    <div class="form-heading">UPDATE CUSTOMER DETAILS</div>
    <form action="phpupd_cust.php?id=<?php echo $id;?>" method="post">
    
    <fieldset disabled>
    <label for="custid"><span>ID<span class="required"> *</span></span>
      <input name="custid" type="text" required class="input-field" id="custid" value='<?=$row['custid'];?>' maxlength="10" /></label>
    </fieldset>
        
        <p>
          <label for="custname"><span>CUST NAME<span class="required"> *</span></span>
